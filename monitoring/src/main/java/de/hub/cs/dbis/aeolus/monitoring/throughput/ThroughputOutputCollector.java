...
class ThroughputOutputCollector extends OutputCollector {
	 ...
	 *            The task ID.
	 */
	public ThroughputOutputCollector(OutputCollector collector, String reportStream, int taskId) {
		super(collector);
		this.counter = new BoltThroughputCounter(collector, reportStream, false, taskId);
	}
