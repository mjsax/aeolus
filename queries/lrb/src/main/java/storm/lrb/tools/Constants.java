...
public class Constants {
	...
	/**
	 * The 4th of the 5 lanes (0-based) of an express way is the exit lane <ref>p.3 LRB paper</ref>.
	 */
	public static final int EXIT_LANE = 4;
	/**
	 * each express way consists of 100 segments in each direction <ref>p. 3 LRB paper</ref>.
	 */
