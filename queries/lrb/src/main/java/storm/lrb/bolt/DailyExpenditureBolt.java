...
public class DailyExpenditureBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        if (fields.contains(TopologyControl.DAILY_EXPEDITURE_REQUEST_FIELD_NAME)) {
            ...
            DaiExpRequest exp = (DaiExpRequest) tuple.getValueByField(TopologyControl.DAILY_EXPEDITURE_REQUEST_FIELD_NAME);
            String out;
            ...
            if (tollAccounts.containsKey(vehicleIdentifier)) {
                ...
                LOG.debug("3, %d, %d, %d, %d", exp.getTime(), exp.getEmitTime(),
