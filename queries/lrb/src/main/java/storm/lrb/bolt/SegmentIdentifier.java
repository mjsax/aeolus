...
public class SegmentIdentifier {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.getDirection() != other.getDirection() && (this.direction == null || !this.direction.equals(other.getDirection()))) {
            return false;
        }
        return !(this.getSegment() != other.getSegment() && (this.segment == null || !this.segment.equals(other.getSegment())));
    }
}
