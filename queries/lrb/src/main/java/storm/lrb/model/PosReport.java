...
public class PosReport extends LRBtuple implements Serializable {
	 ...
	 * @param timer
	 */
	public PosReport(int time, Integer vehicleIdentifier, int currentSpeed, Integer lane,
		...
		super(TYPE, timer.getElapsedTime(), time, vehicleIdentifier, currentSpeed, lane, segmentIdentifier, position,
			queryIdentifier, sinit, send, dow, tod, day, timer);
	}
