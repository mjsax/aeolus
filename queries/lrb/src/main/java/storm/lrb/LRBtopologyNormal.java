...
import storm.lrb.spout.SocketClientSplitSpout;
import storm.lrb.spout.SocketClientSpout;
import storm.lrb.spout.UDPSocketClientSplitSpout;
...
/**
 * Thistopology is equivalent to LrbXD with the difference, that "xway" and
 * "dir" are used in fieldsgrouping of the tollnotificationbolt as opposed to
 * LrbXD where one field is made out of both fields two.
 */
