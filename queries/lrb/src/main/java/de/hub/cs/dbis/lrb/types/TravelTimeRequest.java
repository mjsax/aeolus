...
public class TravelTimeRequest extends AbstractInputTuple {
	 ...
	 * @param xway
	 *            the express way of the planed travel
	 * @param qid
	 *            the query identifier
	 * @param sInit
	 *            the start segment of the planed travel
	 * @param sEnd
	 *            the end segment of the planed travel
	 * @param dow
	 *            the day of the week when the journey would take place
	 * @param tod
	 *            the minute number of the day when the journey would take place
	 */
